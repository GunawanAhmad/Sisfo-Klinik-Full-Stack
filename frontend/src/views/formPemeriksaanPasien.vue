    ...
    <div class="container">
      ...
      <div class="form">
        ...
        <div class="pekerjaan section">
          ...
          <input type="text" name="kerja" class="input" v-model="pekerjaan" />
        </div>
        ...
        <div class="makan section">
          ...
          <input type="text" name="makan" class="input" v-model="makanan" />
        </div>
        <div class="lain section">
          <label for="lain" class="label">Lain-lain</label>
          <input type="text" name="lain" class="input" v-model="lain" />
        </div>
        <div class="diagnosis section">
          <label for="diagnosis" class="label">Diagnosis penyakit</label>
          <input type="text" name="diagnosis" class="input" v-model="diagnosis" />
        </div>
        <div class="catatan section">
          <label for="catatan" class="label">Catatan untuk pasien</label>
          <input type="text" name="catatan" class="input" v-model="catatan" />
        </div>
        <p
          class="warn"
